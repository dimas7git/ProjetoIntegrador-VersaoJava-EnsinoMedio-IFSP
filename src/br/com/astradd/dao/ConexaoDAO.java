 ...
 *
 * @author Andre Luis Gobbi Primo/Marcelo Luis Murari/Izabely
 * @version 2.0
 */
public class ConexaoDAO {
    ...
    public static void ConectDB() {
        try {
            ...
            String dsn = "projeto_integrador"; //nome do banco de dados(igual ao criado no Postgres)
    ...
    /**
     * Método que abre a conexão com o banco de dados para os relatórios 
     * é do tipo static para que não seja necessário instanciar um objeto 
     * da classe, chamando os metodos de forma direta.Ex: classe.nome_do_metodo
     * 
     * @return Connection
    */
